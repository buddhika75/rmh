...
//        billFees
    ...
    public void createTableByKeyword2() {
        ...
        sql = "select b from BilledBill b where b.billType = :billType and b.institution=:ins "
                + " and  ((b.patient.person.name) like :str "
            ...
            if (bills == null) {
                if (txtSearch == null || txtSearch.trim().equals("")) {
                    ...
                    sql = "select b from BilledBill b where b.retired=false and"
                            ...
                            + "and b.billType=:type and b.createdAt between :fromDate and :toDate and ((b.staff.person.name) like '%" + txtSearch.toUpperCase() + "%'  or upper(b.staff.person.phone) like '%" + txtSearch.toUpperCase() + "%'  or upper(b.insId) like '%" + txtSearch.toUpperCase() + "%') order by b.id desc  ";
                }
